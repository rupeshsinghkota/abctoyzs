                ...
                <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-zinc-100">
                    ...
                    <section className="mb-10">
                        ...
                        <p className="text-zinc-600 leading-relaxed mb-4">
                            At ABC Toyz, we want you and your little ones to be thrilled with your purchase. We offer a <strong>10-day replacement window</strong> for any items received with manufacturing defects or shipping damage.
                        </p>
