...
const categories = [
    ...
    // Vehicle Types
    { id: 'supercars', name: 'Supercars', image: '/categories/cat_supercar_1769364520277.png', color: 'from-red-500 to-rose-600', link: '/category/type/supercars' },
    { id: 'suvs', name: 'SUVs', image: '/categories/cat_suv_1769364537319.png', color: 'from-blue-500 to-indigo-600', link: '/category/type/suvs' },
    { id: 'bikes', name: 'Bikes', image: '/categories/cat_motorcycle_1769364560643.png', color: 'from-slate-500 to-gray-600', link: '/category/type/bikes' },
    { id: 'dirtbikes', name: 'Dirt Bikes', image: '/categories/cat_dirtbike.png', color: 'from-orange-500 to-red-600', link: '/category/type/dirtbikes' },
    { id: 'atvs', name: 'ATVs', image: '/categories/cat_atv_1769364577413.png', color: 'from-green-500 to-emerald-600', link: '/category/type/atvs' },
    { id: 'utvs', name: 'UTVs', image: '/categories/cat_utv_1769364600471.png', color: 'from-orange-500 to-red-600', link: '/category/type/utvs' },
    { id: 'gokarts', name: 'Go-Karts', image: '/categories/cat_gokart_1769364617852.png', color: 'from-yellow-500 to-amber-600', link: '/category/type/gokarts' },
    { id: 'scooters', name: 'Scooters', image: '/categories/cat_scooter_1769364639228.png', color: 'from-cyan-500 to-blue-600', link: '/category/type/scooters' },
    { id: 'parts', name: 'Parts', image: '/categories/cat_parts_1769364655385.png', color: 'from-zinc-500 to-slate-600', link: '/category/type/parts' },
];
