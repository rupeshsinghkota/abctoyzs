...
const reviews = [
    { name: "Rahul M.", text: "My son absolutely loves his new Thar jeep! The battery life is amazing and it handles rough terrain easily. Best birthday gift ever!", rating: 5, location: "Mumbai" },
    { name: "Priya S.", text: "I was worried about the assembly, but the support team video call helped me set it up in 10 minutes. excellent service!", rating: 5, location: "Delhi" },
    { name: "Amit K.", text: "Premium quality. Unlike the cheap plastic ones I've seen elsewhere. These feel sturdy and safe. Highly detailed.", rating: 5, location: "Bangalore" },
];
