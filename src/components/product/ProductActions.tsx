        ...
        <div className="space-y-6">
            ...
            <div className="space-y-3 pt-1">
                <div className="flex gap-2 h-12">
                    ...
                    {/* 4. WhatsApp Support (Icon Only) */}
                    <a
                        href={`https://wa.me/918239269217?text=${encodeURIComponent(`Hi, I'm interested in ${product.name} and have a few questions before I buy!`)}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="aspect-square h-full bg-[#25D366] text-white rounded-xl flex items-center justify-center shadow-sm hover:opacity-90 transition-all"
                        title="Chat for help"
                    >
